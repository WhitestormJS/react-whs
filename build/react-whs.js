(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["WHSReact"] = factory(require("whs"));
	else
		root["WHSReact"] = factory(root["WHS"]);
...
var _TransitionBase2 = __webpack_require__(17);
...
function reactify(component) {
  return function (_TransitionBase) {
    _inherits(_class, _TransitionBase);
    ...
    function _class() {
      ...
      _this.native = new component(Object.assign({}, _this.props));
      return _this;
    }
    ...
    return _class;
  }(_TransitionBase2.TransitionBase);
}
...
var TransitionBase = exports.TransitionBase = function (_Component) {
  _inherits(TransitionBase, _Component);
  ...
  function TransitionBase() {
    ...
    _classCallCheck(this, TransitionBase);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TransitionBase.__proto__ || Object.getPrototypeOf(TransitionBase)).call.apply(_ref, [this].concat(args))), _this), _this.defer = [], _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(TransitionBase, [{
    key: 'deferParent',
    value: function deferParent(func) {
    ...
    key: 'applyChildren',
    value: function applyChildren() {
      var _this2 = this;

      var children = this.props.children;

      if (children && children.length > 0) return children.map(function (child) {
    ...
    value: function mount() {
      ...
      if (this.props.onParentMount && this.props.parent) {
        ...
        this.props.onParentMount(function () {
          return _this3.props.parent.add(_this3.native);
        });
      }
...
var App = exports.App = function (_TransitionBase) {
  ...
  function App() {
    ...
    if (_this.props.start) _this.native.start();
    return _this;
  }
...
var _CubeCamera = __webpack_require__(25);
...
var _OrthographicCamera = __webpack_require__(26);
...
var _AmbientLight = __webpack_require__(28);
...
var _DirectionalLight = __webpack_require__(29);
...
var _HemisphereLight = __webpack_require__(30);
...
var _PointLight = __webpack_require__(31);
...
var _Cylinder = __webpack_require__(34);
...
var _Dodecahedron = __webpack_require__(35);
...
var _Extrude = __webpack_require__(36);
...
var _Icosahedron = __webpack_require__(38);
...
var _Lathe = __webpack_require__(39);
...
var _Octahedron = __webpack_require__(42);
...
var _Parametric = __webpack_require__(43);
...
var _Plane = __webpack_require__(44);
...
var _Polyhedron = __webpack_require__(45);
...
var _Shape = __webpack_require__(47);
...
var _Sphere = __webpack_require__(48);
...
var _Tetrahedron = __webpack_require__(49);
...
var _Torus = __webpack_require__(51);
...
var _Torusknot = __webpack_require__(52);
...
var _Tube = __webpack_require__(53);
...
//# sourceMappingURL=react-whs.js.map